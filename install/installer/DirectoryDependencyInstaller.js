...
function DirectoryDependencyInstaller(dependency, placebo) {
    DependencyInstaller.call(this, dependency, placebo);
}

/* DirectoryDependencyInstaller inherits from DependencyInstaller */
inherit(DependencyInstaller, DirectoryDependencyInstaller);

DirectoryDependencyInstaller.prototype.installDependency = function() {
    var directory = this.placebo.findDirectoryCopyLink(this.dependency.version);
    var targetDir = path.join("placebo_node_dirs", this.dependency.dependencyName);
...
DirectoryDependencyInstaller.prototype.adjustProjectPackageJSON = function(packageObj) {
